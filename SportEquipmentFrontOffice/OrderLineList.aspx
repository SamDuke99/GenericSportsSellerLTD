...
<body>
    <form id="form1" runat="server">
        ...
        <asp:Label ID="lblEnterOrderNumber" runat="server" style="z-index: 1; left: 23px; top: 379px; position: absolute" Text="Enter A Order Number"></asp:Label>
        <asp:TextBox ID="txtOrderNumber" runat="server" style="z-index: 1; left: 184px; top: 379px; position: absolute"></asp:TextBox>
